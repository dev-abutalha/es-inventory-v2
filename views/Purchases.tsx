          ...
          <div className="bg-white rounded-t-[2.5rem] sm:rounded-[2.5rem] w-full max-w-5xl max-h-[90vh] shadow-2xl overflow-hidden flex flex-col animate-in slide-in-from-bottom duration-300">
            ...
            <div className="flex-1 overflow-y-auto p-8 space-y-8 custom-scrollbar">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                  ...
                  <input className="w-full bg-slate-50 border-none rounded-2xl px-5 py-4 outline-none font-bold" placeholder="Vendor" value={newPurchase.supplier} onChange={e => setNewPurchase({...newPurchase, supplier: e.target.value})} />
                </div>
              </div>
            ...
            <div className="p-8 bg-slate-50 border-t border-slate-100 flex flex-col sm:flex-row justify-between items-center gap-6 shrink-0">
              ...
              <div className="flex gap-4 w-full sm:w-auto">
                ...
                <button onClick={handleSave} className="flex-1 sm:flex-none py-4 px-10 bg-primary text-white rounded-2xl font-black shadow-lg shadow-primary/20">Save Purchase Record</button>
              </div>
            </div>
          </div>
        </div>
